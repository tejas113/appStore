  ...
  render() {
    return (
      <div className="mainContainer">
        <h1 className="headEdit">App Store</h1>
        <input className="inputEdit" type="search" />
        <div className="tabBarEdit">
          <ul>
            {tabsList.map(eachItem => (
              <TabItem key={eachItem.tabId} tabDetails={eachItem} />
            ))}
          </ul>
        </div>
        <div className="appListContainer">
          <ul>
            {appsList.map(eachItem => (
              <AppItem key={eachItem.appId} appsListDetails={eachItem} />
            ))}
          </ul>
        </div>
      </div>
